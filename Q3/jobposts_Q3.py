...
# Weekly Sales Transaction Data: https://www.kaggle.com/madhab/jobposts/
# From Linux command line
# Get kaggle API KEY from the account
# Install the file in ~/.kaggle/kaggle.json
# kaggle datasets download -d madhab -f data\ job\ posts.csv
...
print(duration)
duration.to_csv(r'results/Q3_f_duration.csv')

# I intentionally put exit function here as the rest of the code will not be executed as
# it needs database and AWS permission
# Please note that I didn't test the code from this point and below
...
########################################################################################################################
# Q3 h) Write the results to an S3 bucket

# Create an S3 client
s3 = boto3.client('s3')

# The files below are created from the code above
testfile1 = 'results/Q3_b_title.csv'
testfile2 = 'results/Q3_b_duration.csv'
testfile3 = 'results/Q3_b_location.csv'
testfile4 = 'results/Q3_b_description.csv'
testfile5 = 'results/Q3_b_Responsibilities.csv'
testfile6 = 'results/Q3_b_qualifications.csv'
testfile7 = 'results/Q3_b_Remuneration.csv'
testfile8 = 'results/Q3_b_application_deadline.csv'
testfile9 = 'results/Q3_b_application_aboutcompany.csv'

bucket_name = 'my-bucket'

# Uploads the given file using a managed uploader, which will split up large
# files automatically and upload parts in parallel.
s3.upload_file(testfile1, bucket_name, testfile1)
s3.upload_file(testfile2, bucket_name, testfile2)
s3.upload_file(testfile3, bucket_name, testfile3)
s3.upload_file(testfile4, bucket_name, testfile4)
s3.upload_file(testfile5, bucket_name, testfile5)
s3.upload_file(testfile6, bucket_name, testfile6)
s3.upload_file(testfile7, bucket_name, testfile7)
s3.upload_file(testfile8, bucket_name, testfile8)
s3.upload_file(testfile9, bucket_name, testfile9)
